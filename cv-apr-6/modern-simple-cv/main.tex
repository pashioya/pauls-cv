...
\begin{tabular}{r| p{0.6\textwidth} c}
    ...
    \cvevent{Ag-Solution}{Niels}{Team Lead}{}{Number: +351 914 663 188 \newline }{agsolution.png} \\
\end{tabular}
...
\begin{skillsection}{\rightcolwidth}
    ...
    \cvitem{\faStar\faStar\faStar\faStar\faStarO}{TypeScript}
...
\begin{skillsection}{\rightcolwidth}
    ...
    \cvitem{\faStar\faStar\faStar\faStarO\faStarO}{Databases(Sql, NoSql)}
\end{skillsection}
